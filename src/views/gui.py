...
class GUI (wx.Frame):
    ...
    def __init__(self, parent):
        ...
        wx.Frame.__init__(self, parent,
                          id=wx.ID_ANY,
                          title=u"Gerador de Crachás",
                          pos=wx.DefaultPosition,
                          size=wx.Size(714, 484),
        ...
        self.m_staticText2 = wx.StaticText(self,
                                           wx.ID_ANY,
                                           u"Gerador de Crachás",
                                           wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        self.m_staticText2.Wrap(-1)

        self.m_staticText2.SetFont(wx.Font(16,
        ...
        self.m_staticline1 = wx.StaticLine(self,
                                           wx.ID_ANY,
                                           wx.DefaultPosition,
                                           wx.DefaultSize,
                                           wx.LI_HORIZONTAL)
        ...
        self.m_staticText9 = wx.StaticText(sbSizer3.GetStaticBox(),
                                           wx.ID_ANY,
                                           u"Feito por: @severino_neto",
                                           wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        self.m_staticText9.Wrap(-1)

        self.m_staticText9.SetFont(wx.Font(8,
        ...
        self.m_staticText10.SetFont(wx.Font(8,
                                            wx.FONTFAMILY_SCRIPT,
                                            wx.FONTSTYLE_ITALIC,
                                            wx.FONTWEIGHT_BOLD,
                                            False, wx.EmptyString))
        ...
        self.m_filePicker2 = wx.FilePickerCtrl(self,
                                               wx.ID_ANY,
                                               wx.EmptyString,
                                               u"Select a file",
                                               u"*.csv",
        ...
        self.m_staticText4 = wx.StaticText(self,
                                           wx.ID_ANY,
                                           u"Selecione a pasta das imagens",
                                           wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        ...
        self.m_dirPicker1 = wx.DirPickerCtrl(self,
                                             wx.ID_ANY,
                                             wx.EmptyString,
                                             u"Select a folder",
                                             wx.DefaultPosition,
        ...
        self.m_staticText5 = wx.StaticText(self,
                                           wx.ID_ANY,
                                           u"Selecione a pasta de saida",
                                           wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        ...
        self.m_dirPicker2 = wx.DirPickerCtrl(self,
                                             wx.ID_ANY,
                                             wx.EmptyString,
                                             u"Select a folder",
                                             wx.DefaultPosition,
        ...
        self.contador_lbl = wx.StaticText(self,
                                          wx.ID_ANY,
                                          u"Gerando ... (num de total)",
                                          wx.DefaultPosition,
                                          wx.DefaultSize, 0)
        self.contador_lbl.Wrap(-1)

        bSizer2.Add(self.contador_lbl, 0, wx.ALL |
                    wx.ALIGN_CENTER_HORIZONTAL, 5)
